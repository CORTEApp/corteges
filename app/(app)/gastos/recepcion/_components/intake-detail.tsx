...
import { CheckCircle2, ExternalLink, FileText, ShieldCheck, Trash2 } from "lucide-react"
            ...
            {approved ? (
              ...
              <form action={approveExpenseInvoiceIntakeAction} className="space-y-5">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <Field label="Base" htmlFor="net_amount">
                    <Input id="net_amount" name="net_amount" type="number" step="0.01" min="0" required defaultValue={inputValue(item.net_amount)} />
                  </Field>

                  <Field label="IVA %" htmlFor="vat_rate">
                    <Input id="vat_rate" name="vat_rate" type="number" step="0.01" min="0" max="100" required defaultValue={inputValue(item.vat_rate ?? 21)} />
                  </Field>

                  <Field label="Total" htmlFor="total_amount">
                    <Input id="total_amount" name="total_amount" type="number" step="0.01" min="0" required defaultValue={inputValue(item.total_amount)} />
                  </Field>

                  <Field label="Moneda" htmlFor="currency">
                    <Input id="currency" name="currency" required maxLength={3} defaultValue={item.currency ?? "EUR"} />
                  </Field>
        ...
        {!approved ? (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Marca el PDF como descartado sin borrar la trazabilidad.</CardDescription>
            </CardHeader>
            <CardContent>
